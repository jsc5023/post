...
class PostGenFile : GenFile {
    ...
    constructor(post: Post, typeCode: TypeCode, fileNo: Int, originalFileName: String,
                metadataStr: String, yyyyMmDd: String, fileExtTypeCode: String,
                fileExtType2Code: String, fileExt: String, fileName: String, fileSize: Long) : super(
